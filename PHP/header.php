      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?php echo SERVER_NAME."/".FOLDER_NAME; ?>/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo SERVER_NAME."/".FOLDER_NAME; ?>/pages/examples/forgot-password.html" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Forgot Password v1</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo SERVER_NAME."/".FOLDER_NAME; ?>/pages/examples/recover-password.html" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
